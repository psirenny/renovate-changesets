...
export const renovateUpgradeSchema = z.looseObject({
...
export type RenovateUpgrade = z.infer<typeof renovateUpgradeSchema>;
export type RenovateUpdateType = NonNullable<RenovateUpgrade["updateType"]>;
